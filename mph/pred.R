...
for(i in 1:nn) {
  ...
  one = read.csv( paste("50k/hsq90", i, "main.mq.gv.csv", sep=".") )
  cor[i,2] = cor(true[45001:50000,i+101], one[45001:50000,2])
  ...
  cor[i,4] = cor(true[45001:50000,i+101], sig[45001:50000,2])
}
...
i = 2
xxx = read.csv( paste("hsq50", i, "funct.mq.gv.csv", sep=".") )
